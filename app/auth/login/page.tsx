  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-pink-50 via-blue-50 to-purple-50 p-4">
      <div className="w-full max-w-md">
        {/* Logo */}
        <Link href="/" className="flex items-center justify-center gap-2 mb-8 transition-opacity hover:opacity-80">
          <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-primary">
            <span className="text-2xl font-bold text-primary-foreground">BB</span>
          </div>
          <span className="text-2xl font-bold tracking-tight text-foreground">BabyBliss</span>
        </Link>
        ...
        <Card className="rounded-3xl border-border/60 shadow-lg">
          ...
          <CardContent>
            ...
            <div className="grid grid-cols-2 gap-3">
              <Button variant="outline" className="rounded-full bg-transparent" type="button">
